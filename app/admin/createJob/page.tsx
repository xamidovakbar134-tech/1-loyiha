...
export default function CreateJobPage() {
  ...
  return (
    <div className="p-10 max-w-5xl mx-auto min-h-screen bg-gray-50/30">
      <Link
        href="/jobs"
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full bg-[#fafafa] border border-gray-200 p-3 rounded-lg outline-none appearance-none cursor-pointer"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-[#1e3a8a] hover:bg-blue-900 text-white py-3 rounded-xl font-bold transition text-lg shadow-md disabled:opacity-50"
            >
            ...
            <button
              ...
              className="flex-1 bg-white hover:bg-gray-50 text-gray-700 py-3 rounded-xl font-bold border border-gray-200 transition text-lg"
            >
              Reset
            </button>
          </div>
